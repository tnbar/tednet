...
from torcherry.dataset.dali import get_cifar100_iter_dali  # use original data
...
class _Base_CIFAR100(tc.CherryModule):
...
class TRResNet20_CIFAR100(_Base_CIFAR100):
    def __init__(self, rs, dataset_path, seed=233):
        super(TRResNet20_CIFAR100, self).__init__()
        self.data_path = dataset_path
        self.seed = seed
        self.gpu_num = torch.cuda.device_count()

        self.resnet = tr.TRResNet20(rs, 100)
...
class TRResNet32_CIFAR100(_Base_CIFAR100):
    def __init__(self, rs, dataset_path, seed=233):
        super(TRResNet32_CIFAR100, self).__init__()
        self.data_path = dataset_path
        self.seed = seed
        self.gpu_num = torch.cuda.device_count()

        self.resnet = tr.TRResNet32(rs, 100)
...
class BTTResNet20_CIFAR100(_Base_CIFAR100):
    def __init__(self, rs, dataset_path, seed=233):
        super(BTTResNet20_CIFAR100, self).__init__()
        self.data_path = dataset_path
        self.seed = seed
        self.gpu_num = torch.cuda.device_count()

        self.resnet = btt.BTTResNet20(rs, 100)
...
class BTTResNet32_CIFAR100(_Base_CIFAR100):
    def __init__(self, rs, dataset_path, seed=233):
        super(BTTResNet32_CIFAR100, self).__init__()
        self.data_path = dataset_path
        self.seed = seed
        self.gpu_num = torch.cuda.device_count()
...
class CPResNet20_CIFAR100(_Base_CIFAR100):
    def __init__(self, rs, dataset_path, seed=233):
        super(CPResNet20_CIFAR100, self).__init__()
        self.data_path = dataset_path
        self.seed = seed
        self.gpu_num = torch.cuda.device_count()
...
class CPResNet32_CIFAR100(_Base_CIFAR100):
    def __init__(self, rs, dataset_path, seed=233):
        super(CPResNet32_CIFAR100, self).__init__()
        self.data_path = dataset_path
        self.seed = seed
        self.gpu_num = torch.cuda.device_count()
...
class TTResNet20_CIFAR100(_Base_CIFAR100):
    def __init__(self, rs, dataset_path, seed=233):
        super(TTResNet20_CIFAR100, self).__init__()
        self.data_path = dataset_path
        self.seed = seed
        self.gpu_num = torch.cuda.device_count()

        self.resnet = tt.TTResNet20(rs, 100)
...
class TTResNet32_CIFAR100(_Base_CIFAR100):
    def __init__(self, rs, dataset_path, seed=233):
        super(TTResNet32_CIFAR100, self).__init__()
        self.data_path = dataset_path
        self.seed = seed
        self.gpu_num = torch.cuda.device_count()

        self.resnet = tt.TTResNet32(rs, 100)
...
class TK2ResNet20_CIFAR100(_Base_CIFAR100):
    def __init__(self, rs, dataset_path, seed=233):
        super(TK2ResNet20_CIFAR100, self).__init__()
        self.data_path = dataset_path
        self.seed = seed
        self.gpu_num = torch.cuda.device_count()

        self.resnet = tk2.TK2ResNet20(rs, 100)
...
class TK2ResNet32_CIFAR100(_Base_CIFAR100):
    def __init__(self, rs, dataset_path, seed=233):
        super(TK2ResNet32_CIFAR100, self).__init__()
        self.data_path = dataset_path
        self.seed = seed
        self.gpu_num = torch.cuda.device_count()

        self.resnet = tk2.TK2ResNet32(rs, 100)
