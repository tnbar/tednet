...
class ResNet_CIFAR100(tc.CherryModule):
    def __init__(self, block, num_blocks, dataset_path, seed=233, num_classes=100):
...
def resnet20_cifar100(dataset_path, seed=233, rs=None):
    return ResNet_CIFAR100(BasicBlock, [3, 3, 3], dataset_path, seed=seed)


def resnet32_cifar100(dataset_path, seed=233, rs=None):
    return ResNet_CIFAR100(BasicBlock, [5, 5, 5], dataset_path, seed=seed)
